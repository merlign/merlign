                        ...
                        <div className="p-6 md:p-8 bg-[var(--text)]/[0.02] border-t border-[var(--border)] space-y-4">
                            <div className="relative">
                                <textarea
                                    ...
                                    className="w-full bg-[var(--background)] border border-[var(--border)] rounded-2xl p-4 pr-14 text-[var(--text)] font-sans text-sm focus:outline-none focus:border-primary transition-all min-h-[60px] max-h-[120px] resize-none shadow-sm placeholder:text-[var(--text)]/30"
                                />
                                <button
                                    onClick={handleSend}
