                ...
                >
                    <motion.div variants={fadeUp} className="flex items-center gap-4 mb-2">
                        <a
                            ...
                            className="flex items-center gap-3 py-1 scale-90 origin-left hover:opacity-80 transition-opacity"
                        >
                            ...
                            <div className="flex flex-col justify-center">
                                <div className="flex items-center gap-1 mb-0.5">
                                    ...
                                    <span className="text-[var(--text)] font-sans text-[13px] font-black ml-1 tracking-tight italic">5/5</span>
                                </div>
                            </div>
                        </a>
                    </motion.div>
