            ...
            <div className="relative z-20 w-full content-max-width section-px">
                ...
                >
                    <motion.div variants={fadeUp} className="flex items-center mb-4">
                        <div className="group flex items-center bg-[var(--text)]/[0.03] border border-[var(--border)] backdrop-blur-md rounded-xl md:rounded-xl p-1 md:p-1.5 pr-3 md:pr-5 shadow-lg dark:shadow-2xl">
                            <div className="flex items-center gap-2 md:gap-3 px-1.5 md:px-2.5">
                                ...
                                <span className="text-[var(--text)] font-sans text-base md:text-xl font-black italic tracking-tighter">5.0</span>
                            </div>

                            <div className="w-px h-5 md:h-6 bg-[var(--text)]/10 mx-1.5 md:mx-2" />
...
const Home = () => {
    ...
    return (
        <div className="bg-[var(--background)] min-h-screen">
            <SEO
                title="Webdesigner Boxtel | websites & automatisering voor ZZP | Merlign"
                description="Maatwerk websites, slimme automatiseringen en dashboards voor ZZP en MKB. Live binnen 2 weken, reactie binnen 24 uur. Gevestigd in Boxtel, actief door heel Nederland."
                path=""
                faqs={faqs}
            />
