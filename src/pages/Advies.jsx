            ...
            <section className="relative min-h-[100dvh] flex flex-col pt-24 pb-8 md:pb-12 px-6 overflow-hidden text-center">
                ...
                <div className="absolute inset-0 overflow-hidden pointer-events-none">
                    <motion.div
                        ...
                        className="absolute top-[6%] -left-[20%] md:-left-[8%] w-[65%] md:w-[44%] max-w-[750px] aspect-video bg-white/5 border border-white/10 rounded-2xl"
                    >
                        <img
                    ...
                    <motion.div
                        ...
                        className="absolute bottom-[2%] left-[8%] md:left-[18%] w-[52%] md:w-[40%] max-w-[720px] aspect-video bg-white/5 border border-white/10 rounded-2xl"
                    >
                        <img
                ...
                <div className="flex-1 flex flex-col items-center justify-center relative z-10 max-w-4xl mx-auto space-y-8 md:space-y-12 pt-8 pb-24 md:pt-12 md:pb-36">
