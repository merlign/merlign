...
const DashboardService = () => {
    ...
    return (
        <div className="bg-[var(--background)] min-h-screen">
            <SEO
                title="Business dashboard laten maken | al je cijfers in één overzicht | Merlign"
                description="Business dashboard laten maken voor ZZP of MKB? Van omzet tot advertenties — alles in één helder overzicht. Geen gedoe met Excel, gewoon direct inzicht op je laptop of telefoon."
                path="/dashboard"
                services={[{
                            ...
                            <div className="content-max-width section-px space-y-20 md:space-y-40 relative z-10">
                                ...
                                <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 md:gap-32 items-center">
                                    ...
                                    >
                                        ...
                                        <div className="w-full h-auto border border-[var(--border)] rounded-[2rem] md:rounded-[3rem] bg-[var(--paper)]/60 backdrop-blur-3xl shadow-2xl flex flex-col p-8 md:p-12 space-y-10 md:space-y-16 relative group hover:border-primary/20 transition-all duration-1000">
                                            <div className="flex justify-between items-center">
                                                <div className="h-6 w-32 md:w-48 bg-primary/5 rounded-full" />
                                            ...
                                            <div className="flex items-end gap-2 md:gap-3 h-32 md:h-64">
                                                {[30, 60, 45, 80, 55, 90, 70, 85].map((h, i) => (
                                                    ...
                                                    >
                                                        <div className="absolute -top-10 left-1/2 -translate-x-1/2 bg-primary text-black text-[12px] font-sans font-bold px-3 py-1.5 rounded opacity-0 group-hover/bar:opacity-100 transition-opacity whitespace-nowrap">
                                                            {h}%
                                                        </div>
                                                    </motion.div>
                                                ))}
                                            </div>
                                            <div className="grid grid-cols-3 gap-4 md:gap-8 border-t border-[var(--border)] pt-10">
                                                <div className="space-y-3">
                                                    <div className="h-2 w-1/2 bg-primary/5 rounded-full" />
