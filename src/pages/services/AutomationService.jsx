...
const AutomationService = () => {
    ...
    return (
        <div className="bg-[var(--background)] min-h-screen">
            <SEO
                title="Bedrijfsprocessen automatiseren voor ZZP en MKB | Merlign"
                description="Bedrijfsprocessen automatiseren en tijd besparen? Ik bouw slimme koppelingen die je herhalende werk overnemen — van administratie tot leadopvolging. Minder handwerk, meer resultaat."
                path="/automatisering"
                services={[{
                            ...
                            <div className="content-max-width section-px space-y-20 md:space-y-40 relative z-10">
                                ...
                                <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 md:gap-32 items-center">
                                    ...
                                    >
                                        ...
                                        <div className="w-full max-w-sm border border-[var(--border)] rounded-[2rem] md:rounded-[3rem] bg-[var(--paper)]/60 backdrop-blur-3xl shadow-2xl flex flex-col p-10 md:p-16 space-y-10 md:space-y-16 relative group hover:border-primary/20 transition-all duration-1000">
                                            {[1, 2, 3].map((_, i) => (
                                                <div key={i} className="flex items-center justify-between group/line">
                                                    <div className="flex items-center gap-6 md:gap-8">
                                                        <div className={`w-12 h-12 md:w-16 md:h-16 rounded-2xl bg-primary/5 flex items-center justify-center transition-all duration-1000 ${i === 1 ? 'text-primary bg-primary/10 shadow-lg shadow-primary/10' : 'text-primary/10'}`}>
                                                            <Zap size={24} className="md:scale-125" />
                                                        </div>
                                                        <div className="space-y-2">
                                                            <div className="h-4 w-24 md:w-32 bg-primary/5 rounded-full" />
                                                            <div className="h-2 w-12 md:w-16 bg-primary/5 rounded-full opacity-50" />
                                                        </div>
                                                    </div>
                                                    <div className={`h-8 w-8 md:h-10 md:w-10 rounded-full border border-[var(--border)] flex items-center justify-center transition-all duration-1000 ${i === 1 ? 'bg-primary border-primary scale-110 shadow-xl shadow-primary/30' : 'opacity-20 translate-x-4'}`}>
                                                        {i === 1 && <Check size={18} className="text-black md:scale-125" />}
                                                    </div>
                                                </div>
                                            ))}
                                            <div className="pt-10 md:pt-16 border-t border-[var(--border)] flex flex-col items-center gap-4">
